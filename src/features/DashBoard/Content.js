...
const Content = ({ route }) => {
  ...
  return (
    <div className="bg-slate-800 text-white font-medium p-2 ">
      ...
      <div class="bg-slate-600  max-w-[95%] shadow-lg shadow-gray-500 p-4 py-5 px-3  m-5 rounded-lg overflow-scroll">
        ...
        <div className="mt-5 flex justify-between ">
          ...
          <div className="flex gap-1 hidden sm:block">
        ...
        <div className="mt-5 flex flex-col sm:flex-row justify-between gap-2 sm:gap-0">
          ...
          <div class="ml-0 sm:ml-10  bg-slate-800 flex gap-2  rounded-lg shadow-lg py-5 px-3">
            <div className="flex flex-col -mt-2">
          ...
          <div class="flex gap-1  rounded-lg">
            <div class="bg-slate-800 rounded-lg shadow-lg p-1 w-42">
              ...
              <h2 className="font-normal text-sm">{formatDate(currentTime)}</h2>
            </div>
      ...
      <div class="bg-slate-600  max-w-[95%] shadow-lg shadow-gray-500 p-4 py-5 px-3  m-5 rounded-lg overflow-scroll">
        <div class="flex flex-col sm:flex-row justify-evenly p-2 ">
          <h2 class="text-white w-[100%] sm:w-[15%]">December ,2023</h2>
          <h2 class="text-white  w-[100%] sm:w-[70%]  mt-5 sm:-mt-2">
            <button
              className={`${
          ...
          <h2 class="text-white  w-[100%] sm:w-[15%]  mt-5 sm:-mt-2">
            {" "}
            <button
              className={`${
        ...
        <table className="min-w-full divide-y divide-gray-200 mt-4">
          ...
          <tbody className="bg-white divide-y divide-gray-200 ">
            {tableData.map((row, index) => (
              <tr
                key={index}
                className={index % 2 === 0 ? "bg-slate-600" : "bg-slate-400"}
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap ml-3">
                  {row.attendanceVisual === "Present" ? (
                    ...
                    <svg
                      ...
                      viewBox="0 0 200 100"
                    >
                      <rect x="10" y="45" width="100" height="10" fill="red" />
